...
// helps us get the id when making request to the api
...
<template>
      ...
      <div class="grid grid-cols-1 md:grid-cols-[70%_30%] w-full gap-6">
        <main>
          ...
          >
            ...
            >
              <i class="pi pi-map-marker text-orange-700 mr-2 pt-1"></i>
  ...
  <div v-else class="flex justify-center items-center text-gray-500 py-6">
    <PulseLoader />
  </div>
</template>
